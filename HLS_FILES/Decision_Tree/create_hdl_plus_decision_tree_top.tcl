...
# This Tcl file will import SmartHLS generated Verilog and create an HDL+ core for the top-level module decision_tree_top in Libero.
...
set srcFiles [concat \
    $hlsPrjAbsPath/hls_output/rtl/decisiontreefinal_decision_tree.v \
...
create_hdl_core \
    -file "$hlsPrjAbsPath/hls_output/rtl/decisiontreefinal_decision_tree.v" \
